  ...
  <div>
    <a-card :title="simple ? '最近添加的供应商' : ''">
      <div v-if="!simple">
        ...
        <space-between>
          <div class="search">
            <a-input-search placeholder="根据供应商名搜索" enter-button v-model:value="keyword" @search="onSearch" />
    ...
    <update v-model:show="showUpdateModal" :supplier="curEditSupplier" @update="updateCurSupplier"></update>
  </div>
</template>
